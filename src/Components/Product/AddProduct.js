          ...
          <form onSubmit={saveProduct}>
            <div className="row my-5 row-content">
              <div className="col-md-4 text-center">
                  ...
                  <OverlayTrigger placement="bottom" overlay={<Tooltip id="button-tooltip-2">Upload a photo</Tooltip>}>
                    {({ ref, ...triggerHandler }) => (
                      <>
                        ...
                        <input type="file" required className="foto-input" name="foto" onChange={handleFoto} id="foto" hidden></input>
                        {error.file ? <p className="text-danger fw-bold fs-6">{error.file}</p> : <></>}
                      </>
                    )}
                  </OverlayTrigger>
                </div>
                <button type="button" class="take-pic-button mt-3">
                  Take a picture
                </button>
                <br />
                <button type="button" className="gallery-button mt-3">
                ...
                <input type="time" className=" w-100" required />
                <br />
                ...
                <input type="number" min={0} className="mt-3 w-100" onChange={(e) => setStock(e.target.value)} required />
              </div>
              <div className="col-md-6 mt-5">
                ...
                <button type="button" className="size-add-prod mt-2">
                  R
                </button>
                <button type="button" className="size-add-prod mx-4">
                  L
                </button>
                <button type="button" className="size-add-prod">
                  XL
                </button>
                <button type="button" className="size-add-prod ms-4">
                  250 gr
                </button>
                <button type="button" className="size-add-prod mx-4">
                  300 gr
                ...
                <div className="row my-5 p-0">
                  <div className="col-md-12  ">
                    <button type="button" className="cancel-add-product" onClick={() => window.location.reload()}>
                      Cancel
                    </button>
                  </div>
                </div>
