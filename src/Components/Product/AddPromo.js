          ...
          <form onSubmit={saveChange}>
            <div className="row my-5 row-content">
              ...
              <div className="col-md-6 mt-5">
                ...
                <input type="text" required className="user-contact-text mt-3" name="product_name" placeholder="Type promo name min. 50 characters" onChange={(e) => setName(e.target.value)} />
                <h2 className="top-product-desc-add mt-5"> Price :</h2>
                <input type="text" required className="user-contact-text mt-3" name="product_price" placeholder="Type the price" />
